    ...
    context 'given schedule starting at 4-2-2012 at 12 hours' do
      ...
      context 'given rule of type DayCycleRule initialized to ' \
        ...
        context 'calculating from 3-2-2012' do
          ...
          it 'returns 7-2-2012 at 12am as third occurrence' do
            expect(third_occurrence).to eq(Time.new(2012, 2, 7, 12))
          end

          it 'returns 8-2-2012 at 12am as fourth occurrence' do
            expect(fourth_occurrence).to eq(Time.new(2012, 2, 8, 12))
          end
          ...
          it 'returns 13-2-2012 at 12am as seventh occurrence' do
            expect(seventh_occurrence).to eq(Time.new(2012, 2, 13, 12))
          end

          it 'returns 14-2-2012 at 12am as eighth occurrence' do
            expect(eighth_occurrence).to eq(Time.new(2012, 2, 14, 12))
          end
        end
      end
